...
public class MainApp extends Application {
    ...
    public void showArtistOverview() {
        try {	
        	...
        	try {
    			while(rs.next()){
    				artistData.add(new ArtistModel(rs.getString("artist"), rs.getString("description"), rs.getInt("id")));
    			}
    ...
    public void showPlanOverview(){
    	try {
        	...
        	try {
    			while(rs.next()){
    				planData.add(new PlanModel(rs.getInt("id") ,rs.getString("artists.artist"), rs.getString("stages.stage"), rs.getInt("planning.start_time"), rs.getInt("planning.end_time")));
    			}
    		} catch (SQLException e) {
    			e.printStackTrace();
    		}
