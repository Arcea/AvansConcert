...
public class StageOverviewController {
    ...
    private void initialize() {
        ...
        stagesTable.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> showStageDetails(newValue));
    }
    ...
    private void handleEditStage(){
    	...
    	if(selectedStage != null){
    		...
    		DatabaseController.EditStage(selectedStage.getId(), selectedStage.getStage(), selectedStage.getStageDescription());
    		if(okClicked){
